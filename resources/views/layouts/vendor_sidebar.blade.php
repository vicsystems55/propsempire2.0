            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="layouts-horizontal">All Listings</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="layouts-horizontal">All Plans</a></li>
                        <li><a href="layouts-compact-sidebar">My Subscriptions</a></li>
                        <li><a href="layouts-icon-sidebar">History</a></li>
